                    ...
                    <ul class="treeview-menu">
                        ...
                        <?php if($this->permission1->method('cw_purchase','create')->access()){ ?>
                            <li class="treeview <?php if ($this->uri->segment('2') == ("cw_purchase")){
                                ...
                                echo " ";
                            }?>"><a href="<?php echo base_url('Crqsn/cw_purchase') ?>">Central Warehouse to Purchase</a></li>
                        <?php }?>
                        ...
                        <?php if($this->permission1->method('rqsn_list','create')->access()){ ?>
                            <li class="treeview <?php if ($this->uri->segment('2') == ("rqsn_list")){
                                ...
                                echo " ";
                            }?>"><a href="<?php echo base_url('Crqsn/rqsn_list') ?>">Stock Transferred Reports(CW)</a></li>
                        <?php }?>
...
<!--                            <li class="treeview --><?php //if ($this->uri->segment('1') == ("outlet_return_form") && $this->uri->segment('2') == ("")){
//                                echo "active";
//                            } else {
//                                echo " ";
//                            }?><!--"><a href="--><?php //echo base_url('Cretrun_m/outlet_return_form') ?><!--">Outlet --><?php //echo display('return'); ?><!--</a></li>-->
<!--                        --><?php //} ?>
                        ...
                        <?php if($this->permission1->method('outlet_return_list','read')->access()){ ?>
                            <li class="treeview <?php if ($this->uri->segment('2') == ("outlet_return_list")){
                                ...
                                echo " ";
                            }?>"><a href="<?php echo base_url('Cretrun_m/outlet_return_list') ?>">Outlet Return List</a></li>
                        <?php } ?>
                        ...
                        <?php if($this->permission1->method('wastage_outlet_return_list','read')->access()){ ?>
                            <li class="treeview <?php if ($this->uri->segment('2') == ("wastage_outlet_return_list")){
                                ...
                                echo " ";
                            }?>"><a href="<?php echo base_url('Cretrun_m/wastage_outlet_return_list') ?>"><?php echo display('wastage_return_list') ?> From Outlet</a></li>
                        <?php } ?>
                    ...
                    <ul class="treeview-menu">
                        ...
                        <?php if($this->permission1->method('purchase_report_supplier_wise','read')->access()){ ?>
                            <li class="treeview <?php if ($this->uri->segment('2') == ("purchase_report_supplier_wise")){
                                ...
                                echo " ";
                            }?>"><a href="<?php echo base_url('Admin_dashboard/purchase_report_supplier_wise') ?>">Supplier Wise Purchase Report</a></li>
                                ...
                                <ul class="treeview-menu">
                                    ...
                                    <?php if($this->permission1->method('balance_sheet_report','read')->access()){ ?>
                                        <li class="treeview <?php if ($this->uri->segment('2') == ("balance_sheet_report")){
                                            ...
                                            echo " ";
                                        }?>"><a href="<?php echo base_url('accounts/balance_sheet_report') ?>">Balance Sheet</a></li>
                                    <?php } ?>
