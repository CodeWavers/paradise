    ...
    <nav class="navbar navbar-static-top text-center">
        ...
        if ($this->uri->segment(2) != $urcolp) {
            ...
            <?php if ($this->permission1->method('customer_receive', 'create')->access()) { ?>
                <a href="<?php echo base_url('accounts/customer_receive') ?>" class="btn btn-success btn-outline"><i
                            class="fa fa-money"></i> <?php echo display('customer_receive') ?></a>
            <?php } ?>

            <?php if ($this->permission1->method('supplier_payment', 'create')->access()) { ?>
                <a href="<?php echo base_url('accounts/supplier_payment') ?>" class="btn btn-success btn-outline"><i
                            class="fa fa-money" aria-hidden="true"></i> <?php echo display('supplier_payment') ?></a>
            <?php } ?>

            <?php if ($this->permission1->method('add_purchase', 'create')->access()) { ?>
                <a href="<?php echo base_url('Cpurchase') ?>" class="btn btn-success btn-outline"><i
        ...
        <div class="navbar-custom-menu">
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown dropdown-user">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <i class="fa fa-birthday-cake"></i><span
                                class="label label-danger"><?php echo html_escape($birthday_count) ?></span></a>
                    <ul class="dropdown-menu">
                        ...
                        <?php elseif ($birthday_count > 1): ?>
                            ...
                            <li><a href="<?php echo base_url('Creport/birthday_noti') ?>"><i
                                            class="pe-7s-users"></i><?php echo html_escape($birthday[0]['first_name']) ?>
...
<aside class="main-sidebar">
    ...
    <div class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <?php if ($this->permission1->method('create_product', 'create')->access() || $this->permission1->method('add_product_csv', 'create')->access() || $this->permission1->method('manage_product', 'read')->access() || $this->permission1->method('create_category', 'create')->access() || $this->permission1->method('manage_category', 'read')->access() || $this->permission1->method('add_unit', 'create')->access() || $this->permission1->method('manage_unit', 'read')->access()) { ?>
                ...
                ?>">
                    ...
                    <ul class="treeview-menu">
                        ...
                        //                            }
                        //                            ?><!--"><a href="-->
                        <?php //echo base_url('Creport/product_price') ?><!--">Price Ledger</a></li>-->
                        <!--                        --><?php //}?>
            ...
            <?php if ($this->permission1->method('reacquisition', 'create')->access() || $this->permission1->method('rqsn_form', 'create')->access() || $this->permission1->method('cw_purchase', 'create')->access()) { ?>
                ...
                ?>">
                    ...
                    <ul class="treeview-menu">
                        ...
                        //                                echo " ";
                        //                            }?><!--"><a href="-->
                        <?php //echo base_url('Crqsn/add_rqsn_form') ?><!--">Add Requisition</a></li>-->
                        <!--                        --><?php //}?>
            ...
            <?php if ($this->permission1->method('approval', 'create')->access() || $this->permission1->method('aprove_rqsn', 'create')->access() || $this->permission1->method('aprove_rqsn_outlet', 'create')->access() || $this->permission1->method('aprove_rqsn_purchase', 'create')->access()) { ?>
                ...
                ?>">
                    ...
                    <ul class="treeview-menu">
                        ...
                        //                                echo " ";
                        //                            }?><!--"><a href="-->
                        <?php //echo base_url('Crqsn/aprove_rqsn_edit') ?><!--">Approve Requisition</a></li>-->
                        <!--                        --><?php //}?>
            ...
            <?php if ($this->permission1->method('add_return', 'create')->access() || $this->permission1->method('return_list', 'read')->access() || $this->permission1->method('supplier_return_list', 'read')->access() || $this->permission1->method('outlet_return_list', 'read')->access() || $this->permission1->method('wastage_return_list', 'read')->access() || $this->permission1->method('wastage_outlet_return_list', 'read')->access()) { ?>
                ...
                ?>">
                    ...
                    <ul class="treeview-menu">
                        ...
                        //                                echo " ";
                        //                            }?><!--"><a href="-->
                        <?php //echo base_url('Cretrun_m/outlet_return_form') ?><!--">Outlet -->
                        <?php //echo display('return'); ?><!--</a></li>-->
                        <!--                        --><?php //} ?>
            ...
            <?php if ($this->permission1->method('warrenty_return', 'create')->access() || $this->permission1->method('return_list', 'read')->access() || $this->permission1->method('supplier_return_list', 'read')->access() || $this->permission1->method('wastage_return_list', 'read')->access()) { ?>
                ...
                ?>">
                    ...
                    <ul class="treeview-menu">
                        ...
                        //                        echo " ";
                        //                    }?><!--"><a href="-->
                        <?php //echo base_url('Cwarrenty/return_list') ?><!--">Stock return list</a></li>-->
                        <!--                      --><?php //} ?>
                    ...
                    <ul class="treeview-menu">
                        ...
                        <?php if ($this->permission1->method('customer_receive', 'create')->access()) { ?>
                            <li class="treeview <?php if ($this->uri->segment('2') == ("customer_receive")) {
                                ...
                                <a href="<?php echo base_url('accounts/customer_receive') ?>"><?php echo display('customer_receive'); ?></a>
                            </li>
                        <?php } ?>
                                ...
                                <ul class="treeview-menu">
                                    ...
                                    <?php if ($this->permission1->method('supplier_payment_report', 'read')->access()) { ?>
                                        <li class="treeview <?php if ($this->uri->segment('2') == ("general_ledger")) {
                                            ...
                                            <a href="<?php echo base_url('admin_dashboard/supplier_payment_report') ?>">Supplier
                                                Payment Report</a></li>
                                    <?php } ?>
                                    ...
                                    <?php if ($this->permission1->method('customer_recieve_report', 'read')->access()) { ?>
                                        <li class="treeview <?php if ($this->uri->segment('2') == ("general_ledger")) {
                                            ...
                                            <a href="<?php echo base_url('admin_dashboard/customer_recieve_report') ?>">Customer
                                                Recieve Report</a></li>
                                    <?php } ?>
                                    ...
                                    <?php if ($this->permission1->method('balance_sheet_report', 'read')->access()) { ?>
                                        <li class="treeview <?php if ($this->uri->segment('2') == ("balance_sheet_report")) {
                                            ...
                                            echo " ";
                                        } ?>"><a href="<?php echo base_url('accounts/balance_sheet_report') ?>">Balance
                                                Sheet</a></li>
                                    <?php } ?>
            ...
            //                                echo " ";
            //                            }?><!--"><a href="-->
            <?php //echo base_url('Csettings/bkash') ?><!--">Add Bkash Number</a></li>-->
            <!--                        --><?php //}?>
            <!---->
            ...
            //                                echo " ";
            //                            }?><!--"><a href="-->
            <?php //echo base_url('Csettings/bkash_list') ?><!--">Manage Bkash</a></li>-->
            <!--                        --><?php //}?>
            ...
            //                                echo " ";
            //                            }?><!--"><a href="-->
            <?php //echo base_url('Csettings/bkash_transaction') ?><!--">Bkash Transaction</a></li>-->
            <!--                        --><?php //}?>
            <!---->
            ...
            //                                echo " ";
            //                            }?><!--"><a href="-->
            <?php //echo base_url('Csettings/bkash_ledger') ?><!--">Bkash Ledger</a></li>-->
            <!--                        --><?php //}?>
            <!--                    </ul>-->
            <!--                </li>-->
            <!--            --><?php //} ?>
