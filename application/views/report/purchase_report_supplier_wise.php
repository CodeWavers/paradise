...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            ...
            <small>Supplier Wise Purchase Report</small>
            <ol class="breadcrumb">
            ...
            <div class="col-sm-12">
                <div class="panel panel-default">
                    <div class="panel-body"> 
                        <?php echo form_open('Admin_dashboard/filter_purchase_report_supplier_wise', array('class' => 'form-inline', 'method' => 'post')) ?>
                        <?php
                        date_default_timezone_set("Asia/Dhaka");
                        $today = date('Y-m-d');
                        ?>
                        <div class="form-group">
                            <label class="" for="category">Supplier</label>
                            <select  name="supplier" class="form-control" id="category">
                        ...
                        <div id="purchase_div" class="table-responsive">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        if ($purchase_report_category_wise) {
                                            foreach ($purchase_report_category_wise as $single) {
                                                ?>
                                                <tr>
                                        <td><?php echo html_escape($single->supplier_name); ?></td>
                                    ...
                                    <tfoot>
                                        <tr>
                                            <td colspan="6" class="text-right"><b>Total Purchase</b></td>
