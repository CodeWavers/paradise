...
// });
    ...
    $.ajax({
        ...
        dataType:'json',
        async:false,
        data:{purchase_id:purchase_id,csrf_test_name:csrf_test_name,cheque_date:cheque_date,hidden_status:hidden_status,cheque_no:cheque_no,supplier_id:supplier_id,due_amount:due_amount,paid_amount:paid_amount,debit_amount:debit_amount,chalan_no:chalan_no},
        success:function(data)
        {
