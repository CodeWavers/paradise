...
// });
        ...
        $("#ProjectEditForm").on('submit',function(event)
        {
            ...
            $.ajax({
                ...
                dataType:'json',
                async:false,
                data:{invoice_id:invoice_id,cheque_id:cheque_id,csrf_test_name:csrf_test_name,cheque_date:cheque_date,payment_date:payment_date,hidden_status:hidden_status,cheque_no:cheque_no,customer_id:customer_id,due_amount:due_amount,paid_amount:paid_amount,credit_amount:credit_amount,invoice:invoice},
                success:function(data)
                {
