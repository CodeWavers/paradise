...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            <h1>Outlet <?php echo display('return_list') ?></h1>
            <small>Outlet <?php echo display('return_list') ?></small>
            <ol class="breadcrumb">
                <li><a href="#"><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
                <li><a href="#">Outlet<?php echo display('return') ?></a></li>
                <li class="active">Outlet<?php echo display('return_list') ?></li>
            </ol>
        </div>
    </section>
            ...
            <div class="col-sm-12">
                <div class="panel panel-default">
                    <div class="panel-body"> 
                        <?php echo form_open('Cretrun_m/datewise_outlet_return_list', array('class' => 'form-inline')) ?>
                        <?php
                        $today = date('Y-m-d');
                        ?>
