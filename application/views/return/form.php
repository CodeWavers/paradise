        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <h4>Return From Outlet</h4>
                        </div>
                    </div>
                    <div class="panel-body">
                        <?php echo form_open('Cretrun_m/outlet_return',array('class' => 'form-inline'))?>

                        <div class="form-group">
                            <label for="to_date"> Reacquisition ID:</label>
                            <input type="text" name="req_id" class="form-control" id="to_date" placeholder="Reacquisition ID" required="required">
                        </div>
