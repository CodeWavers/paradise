                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <label for="supplier_name" class="col-sm-4 col-form-label">Organization Name<i class="text-danger">*</i></label>
                                <div class="col-sm-8">
                                    <input class="form-control" name ="org_name" id="org_name" type="text" placeholder="Organization"  required="" tabindex="1">
                                </div>
                            </div>
                       	<div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <select name="supplier_type" class="form-control" required="" onchange="supp_type(this.value)" tabindex="3">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="form-group row " style="display: none" id="supplier_type">


                                <label for="bank" class="col-sm-4 col-form-label">Select Interval<i class="text-danger">*</i></label>
                                <div class="col-sm-8">
                                    <select name="credit_interval" class="form-control bankpayment"  id="bank_id">
...
<script type="text/javascript">
    "use strict";
    function supp_type(val){



            if(val==2){
                var style = 'block';
                document.getElementById('supplier_type').setAttribute("required", true);
            }else{
                var style ='none';
                document.getElementById('supplier_type').removeAttribute("required");
            }

            document.getElementById('supplier_type').style.display = style;
