    ...
    ?>
      ...
      <tr>
        ...
        <td align="left" class="profitlossbranchead <?php echo ($value <= 3 ? " font-bold " : " "); ?>" font-size="<?php echo (int)(20 - $value * 1.5) . 'px'; ?>">
          <font size="+1"><?php echo ($value >= 3 ? "&nbsp;&nbsp;" : "") . $HeadName; ?></font>
        </td>
              ...
              <table class="table" width="100%" class="table_boxnew" cellpadding="5" cellspacing="0">
                ...
                <tr>
                  ...
                  <td colspan="2" align="center">
                    <h3><b><?php echo display('statement_of_comprehensive_income') ?><br /><?php echo display('from') ?> <?php echo $dtpFromDate ?> <?php echo display('to') ?> <?php echo $dtpToDate; ?></b></h3>
                  </td>
                ...
                <tr>
                  ...
                  <td width="85%" bgcolor="#E7E0EE" align="center">
                    <h4><b><?php echo display('particulars') ?></b></h4>
                  </td>

                  <td width="15%" bgcolor="#E7E0EE" align="center">
                    <h4><b><?php echo display('amount') ?></b></h4>
                  </td>
                ...
                <tr class="profitloss-result">
                  ...
                  <td align="right" class="footersignature">
                    <h4>Profit-Loss <?php echo $TotalAssetF > $TotalLibilityF ? "(Profit)" : "(Loss)"; ?></h4>
                  </td>
