            ...
            <div class="col-sm-12">
                <div class="panel panel-bd">
                    <div id="printableArea"  class="watermark"  onload="printDiv('printableArea')">
                        ...
                        <div class="watermark" style="border-style: double;background-image: url('<?php echo base_url() ?>assets/images/icons/watermark.png') !important;height: 50%">
                                ...
                                <div class="row print_header">
                                    ...
                                    <div class="col-xs-4 text-center " style="margin-bottom: 10px;">
                                        <div style="margin-top:10px;border-style: solid;padding: 5px;">
                                            <?php echo $currency .'&nbsp'. $mr_detail['data'][0]['Credit']?></div>
