                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <select name="cmbDebit" id="cmbDebit" class="form-control" required="" onchange="dbtChange(this.value)">
                            ...
                            <div id="check_div" style="display: none">
                                <label for="check_no" class="col-sm-2 col-form-label">Cheque No.</label>
                                <div class="col-sm-4">
                        ...
                        <div class="form-group row">
                            ...
                            <div id="chq_date_div" style="display: none">
                                <label for="chq_date" class="col-sm-2 col-form-label">Cheque <?php echo display('date') ?></label>
                                <div class="col-sm-4">
                                    <input type="text" name="chq_date" id="chq_date" class="form-control datepicker" autocomplete="off">
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
...
<script type="text/javascript">
    function dbtChange(val) {
        var cq_no_div = $("#check_div");
        var cq_date_div = $("#chq_date_div");
        if (val > 102010201 && val < 102010299) {
            cq_no_div.show();
            cq_date_div.show();
        } else {
            cq_no_div.hide();
