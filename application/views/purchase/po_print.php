                            ...
                            <div class="row print_header">
                                ...
                                <div style="display:flex; justify-content: space-between;">
                                    ...
                                    <div class="col-4 text-left invoice-address">
                                        <div>
                                            <span style="font-weight: bold; font-size:18px">PO No : </span>
                                            <span style="font-size: 18px;"> <?= $all_purchase_list[0]['purchase_order'] ?></span>
                                        </div>
...
<!--                                        </div>-->
                        ...
                        <div class="">
                            <table class="table table-striped table-bordered " cellspacing="0" width="100%" id="add_rqsn_table">
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($all_purchase_list as $all_purchase_list) { ?>
                                        <tr class="text-center">
                                            <td><?php echo $all_purchase_list['sl'] ?> </td>
                                            <td>
                                                <?php echo $all_purchase_list['product_name'] ?>
                                                <input type="hidden" value="<?php echo $all_purchase_list['product_id'] ?>" name="product_id[]" class="form-control" id="">
                                            </td>
                                            <td><?php echo $all_purchase_list['parts'] ?></td>
                                            <td><?php echo $all_purchase_list['sku'] ?></td>
                                            <td><?php echo $all_purchase_list['brand_name'] ?></td>
                                            <td><?php echo $all_purchase_list['model_name'] ?></td>
                                            <td style="width: 5%;"><?php echo $all_purchase_list['qty'] ?></td>
                                            <td style="width: 5%;"><?php echo $all_purchase_list['rate'] ?></td>
                                            <td style="width: 5%;"><?php echo $all_purchase_list['total_amount'] ?></td>
                                    ...
                                    <tr>
                                        <td class="text-left" colspan="8"><b><?php echo display('grand_total') ?>:</b></td>
                    ...
                    <div class="panel-footer text-left">
                        <input type="hidden" name="" id="url" value="<?php echo base_url('Cpurchase/purchase_order_approve_new'); ?>">
