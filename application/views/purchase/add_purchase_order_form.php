...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            <h1><?php echo display('add_purchase') ?> PO</h1>
            <small><?php echo display('add_new_purchase') ?> PO</small>
            <ol class="breadcrumb">
                <li><a href="#"><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
                <li><a href="#"><?php echo display('purchase') ?></a></li>
                <li class="active"><?php echo display('add_purchase') ?> PO</li>
            </ol>
        </div>
    </section>
                ...
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <h4><?php echo display('add_purchase') ?> PO</h4>
                        </div>
                    </div>

                    <div class="panel-body">
                    <?php echo form_open_multipart('Cpurchase/insert_po',array('class' => 'form-vertical', 'id' => 'insert_purchase','name' => 'insert_purchase'))?>
...
<br>
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover" id="purchaseTable">
                                <thead>
                                     <tr>
                                            <th class="text-center" >Purchase Order<i class="text-danger">*</i></th>
                                ...
                                <tbody id="addPurchaseItem">
                                    <tr>
                                        <td class="span3 supplier">
                                           <input type="text" name="product_name" required class="form-control product_name productSelection" onkeypress="product_pur_or_list(1);" placeholder="Purchase Order" id="product_name_1" tabindex="3" >
...
<!--                                        <td class="wt"> <input type="text"  placeholder="SN" name="sn[]" id="sn" class="form-control text-right stock_ctn_1"  /></td>-->
                                            ...
                                            <td class="wt">
                                                <input type="text"  id="pr_ame_1" class="form-control text-right stock_ctn_1" placeholder="Product Name" readonly/>
                                                <input type="hidden" class="autocomplete_hidden_value p_id_1" name="p_id[]" id="p_id_1"/>
...
<!--                                            <td class="wt"> <input type="text" placeholder="Warehouse" name="warehouse[]" id="warehouse" class="form-control text-right stock_ctn_1"  /></td>-->
...
<!--                                            </td>-->
                                            ...
                                            <td class="text-right">
                                                <input type="text" name="product_quantity[]" id="cartoon_1" required="" min="0" class="form-control text-right store_cal_1" onkeyup="" onchange="" placeholder="0.00" value="" readonly tabindex="6"/>
                                            </td>
