                            ...
                            <div class="row ">
                                ...
                                <div class="col-sm-12" style="margin-top: -0.5cm">
                                    ...
                                    <div style="display: flex; justify-content: space-between; margin-top: -0.1cm">
                                        <h4><b>Contact Person.:</b> {contact_person}</h4>
...
<!--                                            <td></td>-->
<!--                                            <td></td>-->
<!--                                            <td style="background-color: #cad1dba1 !important;" class="text-right" colspan="1"><b>Sub-Total:</b></td>-->
<!---->
...
<!--                                        </tr>-->
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        ...
                                        <div class="inv-footer-l">
                                            <span style="display: block;">Delivered By: {delivered_by}<span>
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <div class="inv-footer-r">
                                            <span style="display: block;"><?php echo display('received_by') ?>: {received_by}</span>
                                            <span class="text-center" style="display: block; border-top: 1px solid black; margin-top:0.5in">(Sign with Date)</span>
                                        </div>
                                    </div>
                ...
                <div class="panel-footer text-left">
                    <input type="hidden" name="" id="url" value="<?php echo base_url('Cinvoice/delivery_chalan'); ?>">
                    <a class="btn btn-danger" href="<?php echo base_url('Cinvoice/delivery_chalan'); ?>"><?php echo display('cancel') ?></a>
