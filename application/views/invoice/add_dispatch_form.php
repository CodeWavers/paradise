...
<!-- Invoice js -->
<script src="<?php echo base_url() ?>my-assets/js/admin_js/dispatch.js.php" type="text/javascript"></script>
<style type="text/css">
    .form-control{
        padding: 6px 5px;
    }
...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            <h1>Dispatch</h1>
            <small>Dispatch from Outlet</small>
            <ol class="breadcrumb">
                <li><a href="#"><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
                <li><a href="#">Dispatch</a></li>
                <li class="active">Dispatch from Outlet</li>
            </ol>
        </div>
    </section>
            ...
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        <?php echo form_open_multipart('Cinvoice/dispatch_sales_insert',array('class' => 'form-vertical', 'id' => 'insert_sale','name' => 'insert_sale'))?>
                      <div class="row">
...
<!--                                        </td>-->
                                        <td class="invoice_fields" >
                                            <?php $date = date('Y-m-d'); ?>
                                            <input type="text" style="width: 150px" id="expiry_date" class="form-control expiry_date_1" name="expiry_date[]" value="" readonly/>
                                        </td>
                                        <td class="invoice_fields">
...
<!---->
      ...
      <div class="modal-dialog modal-sm">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <?php echo form_open('Cinvoice/dispatch_inserted_data_manual', array('class' => 'form-vertical', 'id' => '', 'name' => '')) ?>
