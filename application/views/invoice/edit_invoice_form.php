                                ...
                                <div class="col-sm-7">
                                   <select name="bkash_id" class="form-control bankpayment"  id="bkash_id">
                                        ...
                                        <?php foreach($bkash_list as $bkash){?>
                                            <option value="<?php echo html_escape($bkash['bkash_id'])?>" <?php if($bkash['bkash_id'] == $bkash_id){echo 'selected';}?>><?php echo html_escape($bkash['bkash_name']);?></option>
                                        <?php }?>
                                    </select>
                                  <input type="hidden" id="editpayment_type" value="<?php echo $paytype;?>" name="">
                                </div>
...
<!--                                        </td>-->
            ...
            <tfoot>
                                ...
                                <td class="text-right" colspan="11"><b><?php echo html_escape($taxfldt['tax_name']) ?></b></td>
                                <td class="text-right">
                    ...
                    <tr>
                                    <tr>
                                <td class="text-right" colspan="11"><b><?php echo display('total_tax') ?>:</b></td>
                                <td class="text-right">
