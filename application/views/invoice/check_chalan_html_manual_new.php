...
<!--                                        </tr>-->
                ...
                <div class="panel-footer text-left">
                    <input type="hidden" name="" id="url" value="<?php echo base_url('Cinvoice/check_report'); ?>">
                    <a class="btn btn-danger" href="<?php echo base_url('Cinvoice/check_report'); ?>"><?php echo display('cancel') ?></a>
